package com.helpgenie.plugin.cashfreepayment;
...
@CapacitorPlugin(name = "CashfreePaymentGateway")
public class CashfreePaymentGatewayPlugin extends Plugin implements CFCheckoutResponseCallback {
